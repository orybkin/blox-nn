...
class SingleConv2dLSTMCell(nn.Module):
    """ This class implements a ConvLSTM cell. It is taken from Kaixhin's implementation here:
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True):
        ...
        self.register_buffer('wc_blank', torch.zeros([1, out_channels, 1, 1]))
