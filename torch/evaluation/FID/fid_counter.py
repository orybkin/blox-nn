...
class FIDCounter:
    def __init__(self, batch_size=64, dims=2048, cuda=True):
    ...
    def __call__(self, targets, estimates, mask=None):
        ...
        m1, s1 = self.calculate_activation_statistics(targets)
        m2, s2 = self.calculate_activation_statistics(estimates)

        self.FID = calculate_frechet_distance(m1, s1, m2, s2)
        return self.FID
